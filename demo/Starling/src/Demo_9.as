package  
{
	...
	/**
	 * 反向灯光滤镜,可以用作按钮范围发光,高科技设备,这类发光和点光源不同,是扩散的
	 * @-式神-
	 */
	public class Demo_9 extends Sprite 
	{
		...
		private var lightFilter:ShadowFilter
